...
namespace Kroeg.Server.Middleware.Handlers.ServerToClient
{
    public class LikeFollowAnnounceHandler : BaseHandler
    {
        ...
        public LikeFollowAnnounceHandler(StagingEntityStore entityStore, APEntity mainObject, APEntity actor, APEntity targetBox, CollectionTools collection) : base(entityStore, mainObject, actor, targetBox)
        {
